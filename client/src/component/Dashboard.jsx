...
export default function Dashboard() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get("http://localhost:3000/api/getemployeedata", {
                params: { id: userid },
            });
    ...
    const handleDelete = async (empid) => {
        ...
        try {
            const response = await axios.delete("http://localhost:3000/api/deleteemployeedata", {
                data: {
                    id: userid,
                    empid: empid,
                },
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await axios.put("http://localhost:3000/api/updateemployeedata", {
                id: userid,
